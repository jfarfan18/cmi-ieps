...
import ec.edu.ucuenca.ieps.negocio.clientes.EstadoCivilFacade;
...
public class EstadoCivilController implements Serializable {
    ...
    @EJB
    private ec.edu.ucuenca.ieps.negocio.clientes.EstadoCivilFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle1").getString("EstadoCivilCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle1").getString("EstadoCivilUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle1").getString("EstadoCivilDeleted"));
        if (!JsfUtil.isValidationFailed()) {
