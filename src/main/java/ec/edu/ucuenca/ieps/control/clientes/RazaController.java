...
import ec.edu.ucuenca.ieps.negocio.clientes.RazaFacade;
...
public class RazaController implements Serializable {
    ...
    @EJB
    private ec.edu.ucuenca.ieps.negocio.clientes.RazaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle1").getString("RazaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle1").getString("RazaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle1").getString("RazaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
